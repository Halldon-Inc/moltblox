...
import { CylinderChessGame } from './CylinderChessGame';

describe('CylinderChessGame', () => {
  let game: CylinderChessGame;
  const p1 = 'white';
  const p2 = 'black';

  beforeEach(() => {
    game = new CylinderChessGame();
    game.initialize([p1, p2]);
  });

  it('should initialize correctly', () => {
    expect(game.name).toBe('Cylinder Chess');
  ...
  it('should allow standard pawn opening', () => {
